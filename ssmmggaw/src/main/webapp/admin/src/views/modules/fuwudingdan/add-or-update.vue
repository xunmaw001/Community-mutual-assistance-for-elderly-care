<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服务单号" prop="fuwudanhao">
          <el-input v-model="ruleForm.fuwudanhao" 
              placeholder="服务单号" clearable  :readonly="ro.fuwudanhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务单号" prop="fuwudanhao">
              <el-input v-model="ruleForm.fuwudanhao" 
                placeholder="服务单号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服务标题" prop="fuwubiaoti">
          <el-input v-model="ruleForm.fuwubiaoti" 
              placeholder="服务标题" clearable  :readonly="ro.fuwubiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务标题" prop="fuwubiaoti">
              <el-input v-model="ruleForm.fuwubiaoti" 
                placeholder="服务标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服务详情" prop="fuwuxiangqing">
          <el-input v-model="ruleForm.fuwuxiangqing" 
              placeholder="服务详情" clearable  :readonly="ro.fuwuxiangqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务详情" prop="fuwuxiangqing">
              <el-input v-model="ruleForm.fuwuxiangqing" 
                placeholder="服务详情" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="志愿号" prop="zhiyuanhao">
          <el-input v-model="ruleForm.zhiyuanhao" 
              placeholder="志愿号" clearable  :readonly="ro.zhiyuanhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="志愿号" prop="zhiyuanhao">
              <el-input v-model="ruleForm.zhiyuanhao" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.zhiyuanhao!=''&&json.zhiyuanhao){
              		this.ruleForm.zhiyuanhao = json.zhiyuanhao
		}
