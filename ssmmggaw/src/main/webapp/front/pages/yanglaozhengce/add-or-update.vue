	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`yanglaozhengce`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																				...
																																				if(this.ruleForm.id){
					await this.$api.update(`yanglaozhengce`, this.ruleForm);
				}else{
					await this.$api.add(`yanglaozhengce`, this.ruleForm);
				}
